...
sealed trait Instr
case class Cpy(v: Value, y: Value) extends Instr
case class Inc(r: Register) extends Instr
case class Dec(r: Register) extends Instr
case class Jnz(x: Value, y: Value) extends Instr
case class Tgl(r: Register) extends Instr
case class Out(x: Value) extends Instr
